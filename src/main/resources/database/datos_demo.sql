...
((SELECT id_usuario FROM usuarios WHERE correo='maria.gonzalez@skillbridge.com'),'Desarrolladora Backend','Desarrollo','SENIOR','Desarrolladora backend con experiencia en APIs y sistemas empresariales.','Backend, Cloud, DevOps',80),
((SELECT id_usuario FROM usuarios WHERE correo='carlos.ramirez@skillbridge.com'),'Desarrollador Backend','Desarrollo','SEMI_SENIOR','Especialista en Java y Spring Boot.','Microservicios, Docker, AWS',100),
((SELECT id_usuario FROM usuarios WHERE correo='ana.torres@skillbridge.com'),'Desarrolladora Mobile','Desarrollo','SEMI_SENIOR','Desarrolladora enfocada en aplicaciones móviles.','Mobile, UX, APIs',90),
...
((SELECT id_usuario FROM usuarios WHERE correo='sofia.lima@skillbridge.com'),'Desarrolladora Backend','Desarrollo','JUNIOR','Desarrolladora backend en crecimiento.','Java, MySQL, Spring Boot',100),
...
((SELECT id_usuario FROM usuarios WHERE correo='jorge.medina@skillbridge.com'),'Resource Manager','People & Delivery','LEAD','Gestiona capacidad, asignaciones y disponibilidad del equipo.','Talento, Capacity Planning, Gestión',70);
...
((SELECT id_proyecto FROM proyectos WHERE nombre='Plataforma Web'),(SELECT id_usuario FROM usuarios WHERE correo='maria.gonzalez@skillbridge.com'),'Mejores prácticas para autenticación JWT','Necesitamos definir la estrategia de autenticación para el módulo web. ¿Qué recomendaciones tienen?','Desarrollo Web','ABIERTO'),
((SELECT id_proyecto FROM proyectos WHERE nombre='Integración API'),(SELECT id_usuario FROM usuarios WHERE correo='carlos.ramirez@skillbridge.com'),'Error de conexión con API externa','El servicio responde con timeout en pruebas. Comparto el caso para revisar posibles causas.','API','ABIERTO'),
((SELECT id_proyecto FROM proyectos WHERE nombre='Plataforma Web'),(SELECT id_usuario FROM usuarios WHERE correo='diego.morales@skillbridge.com'),'Pruebas de integración','Propongo una lista inicial de escenarios para la integración de módulos.','Testing','RESUELTO');
...
INSERT INTO notificaciones (id_usuario,titulo,mensaje,tipo,leida) VALUES
((SELECT id_usuario FROM usuarios WHERE correo='maria.gonzalez@skillbridge.com'),'Nuevo mensaje de proyecto','Carlos dejó una actualización en el chat de Plataforma Web.','PROYECTO',FALSE),
